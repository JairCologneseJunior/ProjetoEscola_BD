...
-- CURSO(NOME, DESCRICAO, ID_DEPTO)
insert into CURSO
	Values 
(next value for Codigo_do_Cur,'Estatística', 'Cálculos e conceitos matemáticos relacionados à estatísticas.', 1),
(next value for Codigo_do_Cur,'Finanças', 'Fundamentos e noções básicas sobre finanças e mercado de capitais.', 1),
(next value for Codigo_do_Cur,'Ciência da Computação', 'Lógica de Programação com linguagem Python e cálculos matemáticos básicos, Banco de Dados e
técnicas/ferramentas de Data Science e IA.', 9),
(next value for Codigo_do_Cur,'Engenharia Elétrica', 'Técnicas para projetar e implementar instalações e circuitos elétricos.', 1),
(next value for Codigo_do_Cur,'Marketing', 'Conceitos e técnicas para Marketing, trabalhando com ferramentas de propaganda e publicidade.', 2),
(next value for Codigo_do_Cur,'Gestão de RH', 'Psicologia e prática para trabalhar com Recursos Humanos, buscando e explorando habilidades das pessoas.', 2),
(next value for Codigo_do_Cur,'Gestão Comercial', 'Administração e desenvolvimento de propagandas, vendas, gestão de projetos comerciais e liderança de
equipe.', 2),
(next value for Codigo_do_Cur,'Letras', 'Conhecimento e exploração profunda na literatura brasileira e básica na literatura mundial.', 2),
(next value for Codigo_do_Cur,'Inglês', 'Gramática, leitura, audição e conversação do idioma na teoria e prática.', 3),
(next value for Codigo_do_Cur,'Espanhol', 'Gramática, leitura, audição e conversação do idioma na teoria e prática.', 3),
(next value for Codigo_do_Cur,'Alemão', 'Gramática, leitura, audição e conversação do idioma na teoria e prática.', 3),
(next value for Codigo_do_Cur,'Francês', 'Gramática, leitura, audição e conversação do idioma na teoria e prática.', 3);


--MATRICULA(ID_CURSO, CPF, DATA_MATR)
...
--DISCIPLINA(NOME, QTD_CREDITO, MATRICULA_PROF)
insert into DISCIPLINA
Values 
(next value for Codigo_do_DIS,'Cálculo 1', 2, 5),
(next value for Codigo_do_DIS,'Cálculo 2', 3, 1),
(next value for Codigo_do_DIS,'Probabilidade', 4, 8),
(next value for Codigo_do_DIS,'Equações Lineares', 5, 16),
(next value for Codigo_do_DIS,'Matemática Financeira', 3, 17),
(next value for Codigo_do_DIS,'Admin. e Contabilidade', 2, 9),
(next value for Codigo_do_DIS,'Mercado de Capitais', 4, 17),
(next value for Codigo_do_DIS,'Python', 3, 4),
(next value for Codigo_do_DIS,'Data Science e IA', 5, 12),
(next value for Codigo_do_DIS,'Banco de Dados', 6, 20),
(next value for Codigo_do_DIS,'Circuitos Elétricos', 3, 13),
(next value for Codigo_do_DIS,'Instalações Elétricas', 4, 13),
(next value for Codigo_do_DIS,'Elementos do Marketing', 3, 2),
(next value for Codigo_do_DIS,'Mapeamento do Público', 4, 2),
(next value for Codigo_do_DIS,'Criação e Melhorias', 5, 2),
(next value for Codigo_do_DIS,'Mídias Sociais', 6, 2),
(next value for Codigo_do_DIS,'Comportam. do Consumidor', 3, 18),
(next value for Codigo_do_DIS,'Comércio exterior', 4, 6),
(next value for Codigo_do_DIS,'Gestão de Projetos', 5, 6),
(next value for Codigo_do_DIS,'Introd. Psicologia', 2, 18),
(next value for Codigo_do_DIS,'Gestão de Competências', 3, 14),
(next value for Codigo_do_DIS,'Identif. Realoc. de Talentos', 4, 14),
(next value for Codigo_do_DIS,'Concepções de Linguagem', 2, 10),
(next value for Codigo_do_DIS,'Gêneros Literários', 3, 10),
(next value for Codigo_do_DIS,'Variação Linguística', 4, 10),
(next value for Codigo_do_DIS,'Literaturas na Educação Básica', 5, 10),
(next value for Codigo_do_DIS,'Inglês Básico', 2, 19),
(next value for Codigo_do_DIS,'Inglês Intermediário', 3, 19),
(next value for Codigo_do_DIS,'Inglês Avançado', 4, 15),
(next value for Codigo_do_DIS,'Espanhol Básico', 2, 3),
(next value for Codigo_do_DIS,'Espanhol Intermediário', 3, 3),
(next value for Codigo_do_DIS,'Espanhol Avançado', 4, 15),
(next value for Codigo_do_DIS,'Alemão Básico', 2, 11),
(next value for Codigo_do_DIS,'Alemão Intermediário', 3, 11),
(next value for Codigo_do_DIS,'Alemão Avançado', 4, 11),
(next value for Codigo_do_DIS,'Francês Básico', 2, 7),
(next value for Codigo_do_DIS,'Francês Intermediário', 3, 7),
(next value for Codigo_do_DIS,'Francês Avançado', 4, 7);
...
--PROFESSOR(NOME, ENDERECO, TELEFONE, DATA_NASC, ID_DEPTO, DATA_CONTR)
insert into PROFESSOR
	Values 
(next value for Codigo_do_Pro,'Gabriela Genir Marinho', '000 Wright Motorway Suite 352', '+1-006-414-8797', '1954/12/08', 1, '2016/12/13'),
(next value for Codigo_do_Pro,'Marli de Holanda Opinvic', '00183 Charles Mountain', '+1-008-628-9256x246', '1963/01/15', 2, '2016/04/07'),
(next value for Codigo_do_Pro,'Walter Mário de Muniz', '00626 Jonathan Hollow Apt. 314', '+55-11-99999-8888', '1958/03/21', 3, '2016/09/25'),
(next value for Codigo_do_Pro,'Cléber de Vasconcelos', '0134 Murray Walk', '+55-11-4224-2626', '1957/08/09', 9, '2020/10/05'),
(next value for Codigo_do_Pro,'Selena Caroline Cavalcante da Silva', '0137 Shelton Rest Apt. 273', '+1-013-001-8838', '1935/01/04', 1, '2016/11/09'),
(next value for Codigo_do_Pro,'Gabriela da Silva de Macedo', '0165 Drew Junction Suite 552', '+1-026-402-2651', '1930/10/06', 2, '2020/05/17'),
(next value for Codigo_do_Pro,'Heitor Raul de Meireles Rilia', '0181 Ronald Brooks', '+1-032-081-6436', '1950/02/02', 3, '2019/02/06'),
(next value for Codigo_do_Pro,'Gabriela Maria Ribohi Valente', '01932 Garcia Expressway Suite 183', '+1-037-591-5560x81884', '1954/04/20', 9, '2021/05/24'),
(next value for Codigo_do_Pro,'Lúcio Ceilson', '015 Johnson Stravenue Suite 582', '+1-019-168-1103x30298', '1973/04/25', 1, '2021/07/06'),
(next value for Codigo_do_Pro,'Marco Yumoma Neto', '01627 Lopez Path Suite 161', '+1-024-173-1193x0353', '1969/05/22', 2, '2016/04/18'),
(next value for Codigo_do_Pro,'Áureo de Palhares Neiol', '0214 Ramos Bypass Apt. 986', '+55-51-92929-5550', '1951/02/26', 3, '2017/08/24'),
(next value for Codigo_do_Pro,'Sílvia Rosimeire Franco', '022 Thomas Ridges Apt. 464', '+55-11-91010-2020', '1940/04/04', 9, '2019/12/03'),
(next value for Codigo_do_Pro,'João Osvaldo de Oliva do Prado', '02794 Carr Mountains', '+55-11-97887-8007', '1942/05/15', 1, '2020/10/08'),
(next value for Codigo_do_Pro,'Flaviana Supugeko de Arantes', '031 Cook Ville Suite 523', '+55-21-90909-4444', '1996/05/07', 2, '2016/07/30'),
(next value for Codigo_do_Pro,'Ronaldo Severino Berrea Bozuga', '03656 Ward Plaza Apt. 978', '+1-047-466-1919x28434', '1931/01/12', 3, '2017/09/14'),
(next value for Codigo_do_Pro,'Romildo Ademar da Silva Fragoso Júnior', '0377 Joshua Circle', '+1-051-279-6304x91019', '1942/11/25', 9, '2017/09/05'),
(next value for Codigo_do_Pro,'Bella Biwo', '03836 Lydia Creek Apt. 778', '+1-060-465-8808x51762', '1932/08/15', 1, '2016/06/23'),
(next value for Codigo_do_Pro,'Márcio de Oliveira Negrão', '041 Lin Lock', '+1-061-832-1376x6059', '1930/02/21', 2, '2021/06/15'),
(next value for Codigo_do_Pro,'Décio de Leão do Amaral Terceiro', '04312 Haley Island', '+1-065-022-0820', '1981/04/06', 3, '2016/06/03'),
(next value for Codigo_do_Pro,'Moacyr Arthur Góis', '05983 Michael Spring Suite 047', '+55-19-90001-8889', '1986/02/28', 9, '2021/09/05');

--DEPARTAMENTO(NOME)

	insert into DEPARTAMENTO
	Values 
(next value for Codigo_do_dpt,'Exatas'),
(next value for Codigo_do_dpt,'Humanas'),
(next value for Codigo_do_dpt,'Idiomas'),
(next value for Codigo_do_dpt,'Diretoria'),
(next value for Codigo_do_dpt,'Administração'),
(next value for Codigo_do_dpt,'Secretaria'),
(next value for Codigo_do_dpt,'Financeiro'),
(next value for Codigo_do_dpt,'RH'),
(next value for Codigo_do_dpt,'TI');

--PRE_REQ(ID_DISC, ID_DISC_NECESSARIA)
insert into PRE_REQ
Values
(2, 1),
(7, 5),
